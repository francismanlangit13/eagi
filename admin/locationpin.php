...
<div class="wrwr">
    <div class="path">
        ...
        <span>/</span>
        <a href="locationpin.php">Add Zipcode</a>
    </div>
    <div class="rowbtn">
        ...
        while($row=mysqli_fetch_assoc($res)){
            ...
            <input type="text" placeholder="Enter Zipcode" id="sfield" style="width:98.5%;margin:1rem 0;" />
            ...
            <div class="row" style="height:3rem; display:flex;justify-content:space-between;">
                ...
                <div class="block"
                    ...
                    <i class="fa fa-pencil" aria-hidden="true" style="margin-right:1.2rem;" class="k"
                        onclick="editpin(<?php echo $rowt['id']; ?>)"></i>
