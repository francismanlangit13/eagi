    ...
    <div class="catbox-row">
        <div class="catboxp">
            ...
            <div class="formrow">
                ...
                <textarea name="shrtdsc" id="tc" placeholder="Terms & Condition *"
                    style="height:10rem"><?php echo $tc; ?></textarea>
            </div>
            <div class="formrow">
                <div class="heading">
                    Name
            ...
            <div class="formrow">
                ...
                <input type="number" placeholder="Enter Product Selling Price *" id="psprice"
                    value="<?php echo $sellprice; ?>" onkeyup="checkprice()" />
            </div>
            ...
            <div class="formrow">
                ...
                <input type="number" placeholder="Enter Product Tax *" id="tax" onkeyup="tax()"
                    value="<?php echo $tax; ?>" />
            </div>
            <div class="formrow">
                <div class="heading">
            ...
            <div class="formrow">
                ...
                <input type="number" placeholder="Enter Product Shipping Charge *" id="shippimg"
            ...
            <div class="formrow">
                ...
                <input type="number" placeholder="Enter Product Shipping Charge per extra qty *" id="shippingex"
                    value="<?php echo $shippingex; ?>" />
            </div>
            <div class="formrow">
                <div class="heading">
                    SKU
