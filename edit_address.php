                                        ...
                                        <ul class="product-now">
                                            <li>
                                                <input type="radio" id="ad1" name="address1"
                                                    <?php if($row['type_ad']=="Home"){ echo "checked"; } ?>  value="Home"/>
                                                <label for="ad1">Home</label>
                                            </li>
                                            <li>
                                                <input type="radio" id="ad2" name="address1"
                                                    <?php if($row['type_ad']=="Office"){ echo "checked"; } ?> value="Office"/>
                                                <label for="ad2">Office</label>
                                            </li>
                                            <li>
                                                <input type="radio" id="ad3" name="address1"
                                                    <?php if($row['type_ad']=="Other"){ echo "checked"; } ?> value="Other" />
                                        ...
                                        <div class="row2">
                                            ...
                                            <div class="ft">
                                                ...
                                                <input type="number" placeholder="Number" id="dv-number"
                                                    oninput="validate_number()" value="<?php echo $row['user_mobile'] ?>" />
                                            </div>
                                        </div>
