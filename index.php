        ...
        <div class="container mrlAuto">
            ...
            <div class="row mt3 ct-row">
                <div class="owl-carousel owl-theme cate-slider">
                    ...
                    ?>
                        <div class="item">
                            <a class="category-Item" href="view.php?n=<?php echo $row['cat_id'] ?>&k=">
                                <div class="cate-img">
                                    <img src="assets/images/svg/icon-10.svg" alt="" />
                                </div>
