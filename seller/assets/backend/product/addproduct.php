...
$return=array();
if($cro==0){
    $qyery="insert into product(cat_id,scat_id,product_name,img1,img2,img3,img4,price,sell_price,fa,description,qty,isappp,isnew,bs,status,added_by,belonging_city,sku) values('$category','$subcategory','$name','$img1','$img2','$img3','$img4','$price','$sellprice','$fa','$dc','$qty','$inapprove','1','0','$status','$added_by','$added_city','$sku')";
