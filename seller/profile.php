<?php
    ...
    $bal=$r['ballance'];
    $r=mysqli_query($con,"select * from sellers where plan");
          ...
          <div class="col-xxl-6" style="flex-basis: 100%">
            <div class="card">
              ...
              <div class="card-body">
                <div class="media align-items-center">
                  <div class="media-body mr-3">
                    <h4 class="nm2 text-black font-w700">Subscription</h4>
                    <br /><br />
                    <span class="badge red";>
                      ...
                      <?php if($plan=="7"){echo "Premium⁺";} ?></span>
                  </div>
                  <svg
                    width="36"
                    height="36"
                ...
                <div class="h" style="display:none">
                      <a href="edit_subscription.php?hash=<?php echo hash_code() ?>" class="btn-a-a-a">Edit Subscription</a>
                    </div>
              </div>
            </div>
          </div>
